...
#define RED_LED 12   /**< The pin number for the red color in the RGB LED. */
#ifdef ARDUINO_AVR_PROMICRO
  #define GREEN_LED 12 // Pro Micro alternative green LED pin
#else
  #define GREEN_LED 12 /**< The pin number for the green color in the RGB LED. */
#endif
#define BLUE_LED 12   /**< The pin number for the blue color in the RGB LED. */

#define RED_LED_PORT PORTD
#define RED_LED_BIT PORTD6

#ifdef ARDUINO_AVR_PROMICRO
  #define GREEN_LED_PORT PORTD // Pro Micro alternative green LED port
  #define GREEN_LED_BIT PORTD6
#else
...
// bit values for button states
#define LEFT_BUTTON _BV(7)
#define RIGHT_BUTTON _BV(6)
#define UP_BUTTON _BV(3)
#define DOWN_BUTTON _BV(1)
#define A_BUTTON _BV(4)
#define B_BUTTON _BV(0)

#define PIN_LEFT_BUTTON 11  // PB7
#define PIN_RIGHT_BUTTON 10  //// PB6   -----
#define PIN_UP_BUTTON A0 /// PF7  -- 3
#define PIN_DOWN_BUTTON 4 // PF6 -- PD4 -- 2 * 4
#define PIN_A_BUTTON 8  //PB4   ------
#define PIN_B_BUTTON 1 // PF5 -- 1 -- PD3

#define PIN_LEFT_BUTTON 11
#define LEFT_BUTTON_PORT PORTB
#define LEFT_BUTTON_BIT PORTB7

#define PIN_RIGHT_BUTTON 10
#define RIGHT_BUTTON_PORT PORTB
#define RIGHT_BUTTON_BIT PORTB6
...
#define SPEAKER_1_BIT PORTB5

#ifdef ARDUINO_AVR_PROMICRO
  #define PIN_SPEAKER_2 9      //Pro Micro alternative for 2nd speaker pin
  #define SPEAKER_2_PORT PORTB
  #define SPEAKER_2_DDR DDRB
  #define SPEAKER_2_BIT PORTB5
#else
...
#define RAND_SEED_IN 12 // Open analog input used for noise by initRandomSeed()
#define RAND_SEED_IN_PORTD
#define RAND_SEED_IN_BIT PORTD6
...
#define RAND_SEED_IN 7 // Open analog input used for noise by initRandomSeed()
#define RAND_SEED_IN_PORTE
#define RAND_SEED_IN_BIT PORTE6
// Value for ADMUX to read the random seed pin: 2.56V reference, ADC1
#define RAND_SEED_IN_ADMUX (_BV(REFS0) | _BV(REFS1) | _BV(MUX0))
