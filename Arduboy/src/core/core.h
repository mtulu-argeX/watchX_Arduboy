 ...
 *     #define AB_DEVKIT
 */
#define WATCHX_10   //< compile for the production Arduboy v1.0
...
#if defined ARDUINO_AVR_PROMICRO //Pro Micro Alternative OLED CS pin
//  #define CS 1
#else
//  #define CS 12
#endif
...
#define RED_LED 12
#if defined ARDUINO_AVR_PROMICRO  //Pro Micro Alternative GREEN LED pin
  #define GREEN_LED 3
#else
  #define GREEN_LED 13
#endif
...
#define PIN_DOWN_BUTTON 4 // PF6 -- 2
#define PIN_A_BUTTON 8  //PB4   ------
#define PIN_B_BUTTON 1 // PF5 -- 1
...
#define PIN_SPEAKER_1_PORT &PORTB
#define PIN_SPEAKER_1_BITMASK _BV(5)

#if defined ARDUINO_AVR_PROMICRO  //Pro Micro alternative for 2nd speaker pin
  #define PIN_SPEAKER_2 2
  #define PIN_SPEAKER_2_PORT &PORTD

  #define PIN_SPEAKER_2_BITMASK _BV(5)
#else
  #define PIN_SPEAKER_2 9
  #define PIN_SPEAKER_2_PORT &PORTB
